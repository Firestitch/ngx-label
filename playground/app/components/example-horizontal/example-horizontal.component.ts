...
@Component({
    selector: 'example-horizontal',
    templateUrl: 'example-horizontal.component.html',
    styleUrls: ['example-horizontal.component.scss'],
    standalone: true,
    imports: [FsLabelComponent, FsLabelFieldComponent, FsLabelMessageComponent]
})
export class ExampleHorizontalComponent {
}
